...
export const endpoints = {
  ...
  staff: {
    attendance: {
      ...
      shifts: `${STAFF}/shifts/`,
      logs: `${STAFF}/logs/`,
      log: (id: string) => `${STAFF}/logs/${id}/`,
      colleagues: `${STAFF}/colleagues/`,
      shiftSwapRequests: `${STAFF}/shift-swap-requests/`,
      cancelShiftSwapRequest: (id: string) => `${STAFF}/shift-swap-requests/${id}/cancel/`,
    },
    payroll: {
  ...
  admin: {
    ...
    attendance: {
      ...
      shiftSwapRequests: `${ADMIN}/shift-swap-requests/`,
      approveShiftSwapRequest: (id: string) => `${ADMIN}/shift-swap-requests/${id}/approve/`,
      declineShiftSwapRequest: (id: string) => `${ADMIN}/shift-swap-requests/${id}/decline/`,
    },
    payroll: {
      rates: `${ADMIN}/rates/`,
      rate: (id: string) => `${ADMIN}/rates/${id}/`,
      periods: `${ADMIN}/periods/`,
      generateNextPeriod: `${ADMIN}/periods/generate-next/`,
